...
namespace WindowsFormsWord
{
    public partial class Form1 : Form
    {
        ...
        private void NewDocument()
        {
            ...
            {
                WordObj.Range footerRange = wordSection.Footers[WordObj.WdHeaderFooterIndex.wdHeaderFooterPrimary].Range;
                footerRange.Font.ColorIndex = WordObj.WdColorIndex.wdDarkRed;
                footerRange.Font.Size = 10;
                footerRange.ParagraphFormat.Alignment = WordObj.WdParagraphAlignment.wdAlignParagraphCenter;
            ...
            foreach (WordObj.Row row in firstTable.Rows)
            {
                foreach (WordObj.Cell cell in row.Cells)
                {
                    ...
                    if (cell.RowIndex == 1)
                    {
                        ...
                        cell.Range.ParagraphFormat.Alignment = WordObj.WdParagraphAlignment.wdAlignParagraphCenter;
                    }
                    //Значения ячеек
                    else
                    {
